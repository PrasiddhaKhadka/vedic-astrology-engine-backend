...
urlpatterns = [
    ...
    # Phase 5
    path('transits/current/',     views.transits_current,    name='transits-current'),
    path('transits/date/',        views.transits_date,       name='transits-date'),
    path('transits/moon/',        views.transits_moon,       name='transits-moon'),
]